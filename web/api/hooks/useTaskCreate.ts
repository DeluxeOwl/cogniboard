 ...
 * {@link /tasks/create}
 */
export async function taskCreate(data: TaskCreateMutationRequest, config: Partial<RequestConfig<TaskCreateMutationRequest>> & { client?: typeof client } = {}) {
  ...
  const res = await request<TaskCreateMutationResponse, ResponseErrorConfig<Error>, TaskCreateMutationRequest>({
    method: 'POST',
    url: `/tasks/create`,
...
export function useTaskCreate(
  options: {
    mutation?: UseMutationOptions<TaskCreateMutationResponse, ResponseErrorConfig<Error>, { data: TaskCreateMutationRequest }>
  ...
  return useMutation<TaskCreateMutationResponse, ResponseErrorConfig<Error>, { data: TaskCreateMutationRequest }>({
