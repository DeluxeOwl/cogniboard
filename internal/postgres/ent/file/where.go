...
func UploadedAt(v time.Time) predicate.File {
	return predicate.File(sql.FieldEQ(FieldUploadedAt, v))
}
...
func HasTaskWith(preds ...predicate.Task) predicate.File {
	return predicate.File(func(s *sql.Selector) {
		step := newTaskStep()
